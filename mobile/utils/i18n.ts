...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'admin.thumb_gen_desc': 'Generate missing thumbnails (Heavy CPU/GPU)',
        'admin.thumb_concurrency': 'Generation Concurrency',
        'admin.thumb_concurrency_desc': 'Parallel threads for thumbnail generation (Fewer = System Stability, More = Faster)',
        'admin.concurrency_updated': 'Concurrency set to {{count}}',
        'admin.concurrency_warning': 'High concurrency ({{count}}+) may cause server instability or performance issues. Proceed?',
        'admin.smart_repair': 'Smart Analysis',
        'admin.smart_results': 'Found {{missing}} missing, {{error}} corrupted',
        'admin.smart_repair_action': 'Start Smart Repair',
    ...
    zh: {
        ...
        'admin.thumb_gen_desc': '补全缺失的缩略图 (消耗大量 CPU/GPU)',
        'admin.thumb_concurrency': '缩略图生成并发数',
        'admin.thumb_concurrency_desc': '并行生成的线程数 (小 = 系统稳定，大 = 生成更快)',
        'admin.concurrency_updated': '并发数已设置为 {{count}}',
        'admin.concurrency_warning': '高并发数（{{count}}+）可能会导致服务器响应缓慢或系统崩溃。是否确定继续？',
        'admin.smart_repair': '缩略图智慧分析',
        'admin.smart_results': '发现 {{missing}} 个缺失, {{error}} 个损坏',
