                                    ...
                                    <div className="glass-1 rounded-2xl overflow-hidden shadow-2xl border-none">
                                        <div className="p-6 border-b border-white/5 bg-white/[0.02]">
                                            <div className="flex items-center justify-between mb-2">
                                                ...
                                                <button
                                                    onClick={onStartScan}
                                                    className="flex items-center gap-2 px-3 py-1.5 bg-accent-500/10 text-accent-400 hover:bg-accent-500/20 rounded-lg text-xs font-bold transition-all border border-white/5"
                                                >
                                            ...
                                            <form onSubmit={onAddLibraryPath} className="flex gap-2">
                                                ...
                                                <button type="submit" className="px-4 py-2 bg-accent-500 hover:bg-accent-600 text-black font-bold rounded-lg transition-all hover:scale-105 active:scale-95 flex items-center gap-2 shadow-lg shadow-accent-500/20 border border-white/5">
