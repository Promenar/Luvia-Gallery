...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  const mobileHeaderClass = isHome
    ...
    : "bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 shadow-sm transition-colors fixed top-0 left-0 right-0 z-50";
            ...
            <div>
              ...
              >
                ...
                <span className={`ml-auto text-xs px-2 py-0.5 rounded-full transition-colors ${viewMode === 'all'
                  ...
                  : (isHome ? 'bg-gray-800 text-gray-400' : 'bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400')
                  }`}>{totalPhotos}</span>
              </button>
