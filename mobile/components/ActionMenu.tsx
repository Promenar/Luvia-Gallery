...
export const ActionMenu: React.FC<ActionMenuProps> = ({ visible, onClose, item, onToggleFavorite, onDelete }) => {
    ...
    useEffect(() => {
        if (visible) {
            ...
            // Wait for 300ms exiting animation to complete
            ...
            {visible && (
                <View className="flex-1">
                    ...
                    <Pressable
                        ...
                        onPress={onClose}
                    >
                        {/* Smooth Phoenix-style Content Slide */}
                        <Animated.View
                            entering={FadeInUp.duration(300)}
                            exiting={FadeOutDown.duration(300)}
                            className="bg-white dark:bg-zinc-900 w-[90%] rounded-3xl overflow-hidden shadow-2xl border border-gray-100 dark:border-zinc-800"
                        >
                            {/* Header */}
