...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'error.network_offline': 'Unable to connect to server\nCheck network or server status',
        'error.network_timeout': 'Network timeout\nPlease try again',
        'error.server_offline': 'Server temporarily unavailable\nPlease try later',
    ...
    zh: {
        ...
        'error.permission_denied': '权限不足，无法访问',
        'error.network_offline': '无法连接到服务器\n请检查网络连接或服务器状态',
        'error.network_timeout': '网络请求超时\n请稍后重试',
        'error.server_offline': '服务器暂时无法访问\n请稍后重试',
